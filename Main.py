...
class ProcedureWindow(QtWidgets.QMainWindow):
    def __init__(self, parent=None):
        ...
        self.ListWid = QtWidgets.QListWidget(self)
        self.ListWid.setGeometry(10, 60, 371, 321)
        ...
        self.TaskWindow = TaskWindow.TaskWindow(App)
        self.show()
    ...
    def remove_procedure(self):
        ...
        self.Procedures.pop(self.ListWid.row(item))  # pop procedure from the list
